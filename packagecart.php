...
<body>
 ...
 <div class="section-title">
          <h2>My Package <span>Cart</span></h2>
          </div>
        <!-- <div class="section-title">
...
<form method="POST">
        ...
        <div class="row mt-5">
         ...
         <div class="row menu-container">
          <?php 
              $totalAmt = 0;
              $query = mysqli_query($con, "SELECT tblpackage.package_desc, tblorder.order_id, tblorder.qty FROM tblorder INNER JOIN tblcustomer ON tblorder.customer_id=tblcustomer.customer_id INNER JOIN tblpackage ON tblpackage.package_code=tblorder.item_code WHERE tblorder.act_no = 0 AND tblorder.customer_id = $customer_id");
           ...
           <!--  <div class="menu-content">
            ...
            <div class="menu-ingredients">
              <div class="row">
                ...
                <div class="col-md-2">
                  <label><?php echo $row['package_desc']; ?></label>
                </div>
