...
<head>
  ...
  <link href="images/mainlogo.jpg" rel="apple-touch-icon">
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div class="logo me-auto">
        <!-- <h1><a href="customerdashboard.php">Misyel's Catering</a></h1> -->
...
Misyel’s. Truly pangita-ngitaon mo gid guiapon.
    ...
    <section id="menu" class="menu">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Check our <span>Freebies</span></h2>
        </div>
       ...
       <!--  <div class="row">
        ...
        <div class="row menu-container">
          <?php 
              $query = mysqli_query($con, "SELECT * FROM `tblgiveaways` INNER JOIN tblfoods ON tblfoods.food_id=tblgiveaways.food_id INNER JOIN tblcategory ON tblcategory.category_id=tblfoods.category_id WHERE tblgiveaways.active = 1");
              while ($row = mysqli_fetch_array($query)){
                $id = $row['category_id'];
           ?>
          <div class="col-lg-12 menu-item filter-starters">
            ...
            <div class="menu-ingredients ">
              <!-- <?php 
                $query2 = mysqli_query($con,"SELECT * FROM `tblgiveaways` INNER JOIN tblfoods ON tblfoods.food_id=tblgiveaways.food_id INNER JOIN tblcategory ON tblcategory.category_id=tblfoods.category_id WHERE tblgiveaways.active = 1 AND tblfoods.category_id = $id");
                while($row1 = mysqli_fetch_array($query2)){
             ?> -->
             <!--  <a href="#"><?php echo $row1['food_desc']; ?></a><span style="float: right;">&#8369;<?php echo number_format($row1['price'], 2); ?></span> -->
             <li style="list-style: none;"><?php echo $row1['food_desc']; ?> <span style="float: right;">&#8369; <?php echo number_format($row1['limit_price'], 2); ?></span></li>
            <!-- <?php } ?> -->
            </div>
          </div>
        <?php } ?>
