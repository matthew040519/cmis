...
session_start();
  ...
  $queryNotif = mysqli_query($con, "UPDATE `tbltransaction` SET `click`=1 WHERE transaction_id = '$transaction_id'");
 ?>
<!doctype html>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="col-12 mt-5">
                        <!-- <div class="card">
                            <div class="card-body"> -->
                                <h4 style="float: left;" class="header-title"><?php echo $transaction_number ?> List</h4>
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2">
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT * FROM `tbltransaction` INNER JOIN tblstatus ON tblstatus.status_id=tbltransaction.status_id inner join tblcustomer on tblcustomer.customer_id=tbltransaction.customer_id WHERE tbltransaction.transaction_id = '$transaction_id'");
