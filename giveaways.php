            ...
            <div class="main-content-inner">
                ...
                <!-- <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body"> -->
                                <div class="col-12 mt-5">
                                <h4 style="float: left;" class="header-title">Freebies List</h4>
                                <button style="float: right; margin-bottom: 10px;" type="button" class="btn btn-primary btn-flat btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="ti-plus"></i> <span>Freebies Food</span>
                                </button>
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2">
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT tblfoods.food_desc, tblgiveaways.limit_price, tblgiveaways.giveaways_id FROM tblgiveaways INNER JOIN tblfoods on tblfoods.food_id=tblgiveaways.food_id WHERE tblgiveaways.active = 1");
                    ...
                    <div class="modal fade bd-example-modal-lg">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Add Freebies</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST" enctype="multipart/form-data">
                                                   <!--   <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="example-text-input" class="col-form-label">Limit Price</label>
                                                        <input class="form-control" type="number" name="limit_description" id="example-text-input">
                                                    </div>
                                               <!--      <div class="form-group">
                                    ...
                                    <?php 
                                        if (isset($_POST['submit']))
                                        {
                                            ...
                                            $limit_description = number_format($_POST['limit_description'], 2);

                                            // $target = "images/food/". basename($_FILES['food_image']['name']);
                                            // $image = $_FILES['food_image']['name'];

                                            $query = mysqli_query($con, "INSERT INTO `tblgiveaways`(`giveaways_id`, `food_id`, `limit_price`) VALUES (NULL,'$food_description','$limit_description')");
