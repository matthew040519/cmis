    ...
    <section id="menu" class="menu">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Check our tasty <span>Foods</span></h2>
        </div>
       ...
       <!--  <div class="row">
        ...
        <div class="row menu-container">
          ...
          <?php 
                $query2 = mysqli_query($con,"SELECT * FROM tblfoods where active = 1");
           ...
           <!--  <div class="menu-content">
            ...
            <div class="menu-ingredients">
              <?php 
               ...
               ?>
             <img class="gallery-lightbox" width="100%" src="images/food/<?php echo $rowImage['image'] ?>">
             <li style="list-style: none;"><?php echo $row1['food_desc']; ?> <span style="float: right;">&#8369; <?php echo number_format($row1['price'], 2); ?></span></li>

             <li style="list-style: none;">
               <span>Good For (<?php echo $row1['food_serve']; ?>) Person/s</span>
             </li>
              <br>
             <form method="POST" action="order.php?id=<?php echo $row1['food_code']; ?>">
