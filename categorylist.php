                ...
                <div class="col-12 mt-5">
                       <!--  <div class="card">
                            <div class="card-body"> -->
                                ...
                                <button style="float: right; margin-bottom: 10px;" type="button" class="btn btn-primary btn-flat btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="ti-plus"></i> <span>Add Category</span>
                                </button>
                    ...
                    <div class="modal fade bd-example-modal-lg">
                                    ...
                                    <?php 
                                        if (isset($_POST['submit']))
                                        {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO `tblcategory`(`category_id`, `category_desc`) VALUES (NULL,'$category_description')");

                                            echo "<script>window.location.replace('categorylist.php')</script>";
                                        }
