...
<?php 
    ...
    //         $quantity = $_POST['qty'];
            $id = $_GET['id'];
    //         $queryPrice = mysqli_query($con, "SELECT * FROM tblevents WHERE event_code = '$id'");
    //         $fetch = mysqli_fetch_array($queryPrice);
    //         $price = $fetch['events_price'];
    //         if ($quantity == 0)
    //         {
    ...
    //           $query = mysqli_query($con, "INSERT INTO `tblorder`(`order_id`, `customer_id`, `item_code`, `qty`, `tdate`, `price`) VALUES (NULL, '$customerid', '$id', '$quantity', '$tdate', '$total')");
                // echo "<script>window.location.replace('eventmenu.php')</script>";
            echo "<script>
    window.location.replace('eventpackagefood.php?id=$id');
</script>";
// echo "<script>window.location.replace('eventmenu.php')</script>";
// header("Location: eventmenu.php");
// echo "<script>location.reload('order1.php')</script>";
        }
     ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="row justify-content-between mb-3">
                    <div class="col-12 ">
                        ...
                        <br>
                        <h2 class="page-heading">Event Menu</h2>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="owl-carousel offer_card_carousel" id="offer_card_carousel">
                            ...
                            $query = mysqli_query($con, "SELECT * FROM `tblevents` ORDER BY events_id DESC");
                    ...
                    <div class="card vertical-card__menu">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="col-lg-12 pl-0">
                                    <div class="card-body d-flex align-items-center h-100">
                                        <ul class="w-100 m-0">
                                           <p><?php echo $row['events_details']; ?></p>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                ...
                                if ($active == 1){
                             ?>
                                <form method="POST" action="eventmenu.php?id=<?php echo $row['event_code']; ?>">  

                                <div>
                                    <div style="float: left; width: 100%;">
                                      <!--   <span class="icon"><i class="fa fa-map-marker"></i></span>
                                        Quantity:  -->
                                        <input type="number" style="display: none;" class="form-control" value="1" name="qty">
                                        <input type="text" style="display: none;" class="form-control" value="<?php echo $row['event_code']; ?>" name="id">
                                    </div>
                ...
                <div class="row justify-content-between mb-3">
                    <div class="col-12 ">
                        <!-- <h2 class="page-heading">Hi,Welcome Back!</h2> -->
                        <!-- <h2 class="page-heading">Food Menu</h2> -->
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
