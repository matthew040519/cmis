                                    ...
                                    <table id="example" class="display">
                                        ...
                                        <tbody>
                                            <?php 
                                               ...
                                               $query2 = mysqli_query($con,"SELECT *, tblpackage.package_price FROM `tbltransaction` INNER JOIN tblorder ON tbltransaction.transaction_number=tblorder.order_code INNER JOIN tblpackage on tblpackage.package_code=tblorder.item_code WHERE tbltransaction.customer_id='$customerid' AND tbltransaction.status_id = 1");

                while($row = mysqli_fetch_array($query2)){
                    $totalprice = $row['qty'] * $row['package_price'];
                                             ?>
                                            <tr>
