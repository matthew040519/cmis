            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Pending List</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
              ...
              <h4 class="card-title">Pending List</h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php 
                                        ...
                                        $query = mysqli_query($con, "SELECT * FROM `tbltransaction` INNER JOIN tblstatus ON tblstatus.status_id=tbltransaction.status_id inner join tblcustomer on tblcustomer.customer_id=tbltransaction.customer_id WHERE tbltransaction.status_id = 1 AND tbltransaction.tdate >= '$tdate'");
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['transaction_number']; ?></td>
                                                ...
                                                <td><a class="btn-sm btn-primary" href="accept.php?id=<?php echo $row['transaction_id']; ?>&transactionNumber=<?php echo $transaction_number; ?>&customer_id=<?php echo $row['customer_id']; ?>">Accept</a></td>
                                    </tr>
