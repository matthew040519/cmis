                                   ...
                                   <table id="example" class="display">
                                        ...
                                        <tbody>
                                            <?php 
                                               ...
                                               $query2 = mysqli_query($con,"SELECT *, tblpackage.package_price FROM `tbltransaction` INNER JOIN tblorder ON tbltransaction.transaction_number=tblorder.order_code INNER JOIN tblpackage on tblpackage.package_code=tblorder.item_code WHERE tbltransaction.customer_id='$customerid' AND tbltransaction.status_id = 2");
