...
<body>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalpopover"><i class="ti-plus"></i> Add Feedback</button>
              </div>
              ...
              <h4 class="card-title">Feedback List</h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php 
                                        // $id = $_SESSION['id'];
                                        $query = mysqli_query($con, "SELECT * FROM tblfeedback WHERE customer_id = '$id'");
                                    ...
                                    <form method="POST">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input class="form-control" required="" min="1" max="5" type="number" name="rating" id="example-text-input">
  ...
  $tdate = date("m/d/Y");
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO `tblfeedback`(`feedback_id`, `customer_id`, `message`, `tdate`, `ratings`) VALUES (NULL, '$id', '$content', '$tdate', '$rating')");
