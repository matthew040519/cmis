...
<body>
 ...
 <?php 
 $point = 0;
                  $queryimage = mysqli_query($con, "SELECT * FROM `tblfoodimage` WHERE food_code = '$food_code'");
                  while($rowImage = mysqli_fetch_array($queryimage)){
                    $point += 1;
               ?>

  <!-- Full-width images with number and caption text -->
  <div class="mySlides<?php echo $rowImage['fimage_id']; ?> fade">
    <div class="numbertext">1 / 3</div>
    <img src="../../images/food/<?php echo $rowImage['image']; ?>" style="width:100%">
    <div class="text">Caption Text</div>
  </div>

  <!-- div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="../../images/food/mainlogo.jpg" style="width:100%">
    <div class="text">Caption Two</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="../../images/mainlogo.jpg" style="width:100%">
    <div class="text">Caption Three</div>
  </div> -->

  <!-- Next and previous buttons -->
 <!--  <a class="prev" onclick="plusSlides(-1)">&#10094;</a>
  <a class="next" onclick="plusSlides(<?php echo $point; ?>)">&#10095;</a> -->
...
<div style="text-align:center">
  <span class="dot<?php echo $rowImage['fimage_id']; ?>" onclick="currentSlide(<?php echo $point; ?>)"></span>
</div>
...
function showSlides() {
  var i = 0;
  var slides = document.getElementsByClassName("mySlides<?php echo $rowImage['fimage_id']; ?>");
  var dots = document.getElementsByClassName("dot<?php echo $rowImage['fimage_id']; ?>");
  // alert(slides.length);
  ...
  dots[<?php echo $point; ?>].className += " active";
