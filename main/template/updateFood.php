        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Food</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                     <div class="col-sm-6">
                         <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalpopover"><i class="ti-plus"></i> Add Images</button>
                     </div>
                </div>
               <br>
               <div class="row">
                   ...
                   <?php 
                            $sum = 0;
                            $query = mysqli_query($con, "SELECT * FROM `tblfoodimage` INNER JOIN tblfoods ON tblfoods.food_code=tblfoodimage.food_code WHERE tblfoodimage.food_code = '$food_code'");
                                ...
                                <div class="vertical-card__menu--desc p-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="vertical-card__menu--fav">
                                            <!-- <a href="javascript:void()">First Image</i></a> -->
                                        </div>
                                    </div>
                                    <!-- <p>Qty: <?php echo $row['qty']; ?></p> -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h2 class="vertical-card__menu--price"><span>
                                           <!--  <form method="POST" action="updateFood.php?id=<?php echo $food_code; ?>&image_id=<?php echo $row['fimage_id']; ?>" enctype="multipart/form-data">
                                                <input type="submit"  class="btn btn-success" value="Update" name="remove">
                                            </form> -->
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModalpopover<?php echo $code; ?>"><i class="ti-check-box"></i> Update</button>
                                            <a href="deleteImage.php?id=<?php echo $code; ?>&food_code=<?php echo $food_code; ?>" class="btn btn-danger btn-sm">
                                            <i class="ti-close"></i> Remove</a>
                                            <!-- <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModalpopover<?php echo $code; ?>"><i class="ti-check-box"></i> Update</button> -->
                                        </span></h2>
                                        <div class="vertical-card__menu--rating c-pointer">
                                           <!--  <form method="POST" action="updateFood.php?id=<?php echo $row['order_id']; ?>">
                    ...
                    <?php include('../../modals/modalUpdateImage.php'); ?>  
                                            ...
                                            foreach($_FILES["food_image"]["tmp_name"] as $key=>$tmp_name) {
                                                ...
                                                if (move_uploaded_file($_FILES["food_image"]["tmp_name"][$key], $target)){
                                                  // echo "<script>alert('Successfully Upload')</script>";
                                                    $queryImage = mysqli_query($con, "INSERT INTO `tblfoodimage`(`fimage_id`, `image`, `food_code`) VALUES (NULL, '$file_name', '$food_code')");
                                                } 
                                                else {
