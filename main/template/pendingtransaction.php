              ...
              <h4 class="card-title">Pending List</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display">
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT * FROM `tbltransaction` INNER JOIN tblstatus ON tblstatus.status_id=tbltransaction.status_id inner join tblcustomer on tblcustomer.customer_id=tbltransaction.customer_id WHERE tbltransaction.status_id = 1 AND tbltransaction.customer_id = '$customerid'");
