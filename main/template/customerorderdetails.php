...
session_start();
  ...
  $queryNotif = mysqli_query($con, "UPDATE `tblnotification` SET `customer_click`=1 WHERE notification_id = '$transaction_id'");
 ?>
<!DOCTYPE html>
<html lang="en">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
              ...
              <h4 class="card-title">Transaction Number: <strong><i><?php echo $transaction_number; ?></i></strong></h4>
          </div>
                                <div class="table-responsive">
                                    <table id="example" class="display">
                                       <thead class="text-capitalize">
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT * FROM `tbltransaction` INNER JOIN tblstatus ON tblstatus.status_id=tbltransaction.status_id inner join tblcustomer on tblcustomer.customer_id=tbltransaction.customer_id WHERE tbltransaction.transaction_number = '$transaction_number'");
