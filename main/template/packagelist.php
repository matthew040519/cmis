                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display">
                                       <thead>
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT *, (SELECT CASE WHEN tblpackage.active = 1 THEN 'Available' ELSE 'Not Available' END) as status FROM tblpackage ");
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['status']; ?></td>
                                         <td>
                                            <button type="button" class="btn btn-success btn-flat btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg<?php echo $package_id; ?>"><i class="ti-check"></i> <span>Update Package</span> </button> || <a href="updatePackage.php?id=<?php echo $package_id; ?>" class="btn btn-primary">Update Image</a>
                                            <!-- <a class="btn btn-success btn-flat btn-sm" href="food_details.php?id=<?php echo $food_id; ?>">Update Food</a> -->
                                        </td>
                                    </tr>
                                     <?php include('../../modals/modalUpdatePackage.php'); ?>
                                    <?php } ?>
                                        </tbody>
                                    </table>
                                </div>
        ...
        <div class="modal fade" id="exampleModalpopover">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <input class="form-control" type="text" name="package_price" id="example-text-input"> -->
                                                        <textarea class="form-control" rows="4" name="package_details"></textarea>
                                                    </div>
                                            </div>
                                   ...
                                   <?php 
                                         if (isset($_POST['submit']))
                                        {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO `tblpackage`(`package_id`, `package_code`, `package_desc`, `package_price`, `image`, `package_details`) VALUES (NULL,'$randomString','$package_description', '$package_price', '$image', '$package_details')");
