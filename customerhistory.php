            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="customer">
                                ...
                                <?php 
                                    $query = mysqli_query($con, "SELECT * FROM tblcustomer WHERE Active = 1");
                                    while($row = mysqli_fetch_array($query)){
                                 ?>
                                 <option value="<?php echo $row['customer_id']; ?>"><?php echo $row['fullname']; ?></option>
                             <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-3 mt-4">
                        <div class="form-group">
                        <input type="submit" style="margin-top: 7px;" class="btn btn-primary" value="Preview" name="preview">
                        </div>
                    </div>
                </div>
                </form>
                <?php 
                        if(isset($_POST['preview']))
                        {
                            ...
                            $querycustomer = mysqli_query($con, "SELECT * FROM tblcustomer WHERE Active = 1");
                            $fetchrow = mysqli_fetch_array($querycustomer);
                 ?>
                <div class="col-12 mt-5">
                        <!-- <div class="card">
                            <div class="card-body"> -->
                                <h4 style="float: left;" class="header-title"> <?php echo  $fetchrow['fullname']; ?> List</h4>
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2">
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT * FROM `tbltransaction` INNER JOIN tblstatus ON tblstatus.status_id=tbltransaction.status_id inner join tblcustomer on tblcustomer.customer_id=tbltransaction.customer_id WHERE tbltransaction.customer_id = $customer");
                                        while($row = mysqli_fetch_array($query)){
                                     ?>
                                    <tr>
                    ...
                    <div class="modal fade bd-example-modal-lg">
                                    ...
                                    <?php 
                                        if (isset($_POST['submit']))
                                        {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO `tblsetpackage`(`setpackage_id`, `food_id`, `package_id`) VALUES (NULL,'$food_description','$package_description')");
