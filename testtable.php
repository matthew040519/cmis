    ...
    <section id="menu" class="menu">
      <div class="container">
        ...
        <div class="row menu-container">
          <?php 
              $query = mysqli_query($con, "SELECT * FROM tblTransaction WHERE status_id = 1");
          ...
          <div class="col-lg-12 menu-item filter-starters">
            ...
            <div class="menu-ingredients">
              <?php 
                ...
                $query2 = mysqli_query($con,"SELECT * FROM `tbltransaction` INNER JOIN tblorder ON tbltransaction.transaction_number=tblorder.order_code INNER JOIN tblfoods on tblfoods.food_id=tblorder.food_id INNER join tblcategory on tblcategory.category_id=tblfoods.category_id WHERE tblorder.order_code=$refer");
        ...
        $randomString .= $characters[rand(0, $charactersLength - 1)];
          ...
          $tdate = date("m/d/Y");
            ...
            if ($quantity == 0)
            {
              ...
              $query = mysqli_query($con, "INSERT INTO `tblorder`(`order_id`, `food_id`, `qty`, `tdate`) VALUES (NULL,'$id', '$quantity', '$tdate')");
