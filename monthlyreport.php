                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2">
                                        ...
                                        <tbody>
                                    <?php 
                                        $query = mysqli_query($con, "SELECT * FROM tbluser WHERE active = 1");
                    ...
                    <div class="modal fade bd-example-modal-lg">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="status" id="example-text-input">
                                    ...
                                    <?php 
                                        if (isset($_POST['submit']))
                                        {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO `tbluser`(`user_id`, `username`, `password`, `status`) VALUES (NULL,'$username','$password','$status')");
