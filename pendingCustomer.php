...
<div class="section-title">
          <h2>My <span>Pending Reserve</span></h2>
          </div>

        <div class="row menu-container">
          <?php 
              $query = mysqli_query($con, "SELECT * FROM tblTransaction WHERE status_id = 1 AND customer_id=$customerid");
          ...
          <div class="col-lg-12 menu-item filter-starters">
            ...
            <div class="row">
              <div class="col-lg-2">
                  <img style="width: 100px; height: 100px;" class="img-fluid" src="images/food/<?php echo $row1['food_image']; ?>">
                </div>
                <div class="col-lg-2">
